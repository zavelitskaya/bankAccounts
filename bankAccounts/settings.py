"""
Django settings for bankAccounts project.
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'bmstu_lab/static'),  # если есть глобальная static папка
]
...
INSTALLED_APPS = [
    ...
    'django.contrib.messages',
    'django.contrib.staticfiles',
    'bmstu_lab',  # ← Добавляем наше приложение
    'storages',   # ← Для работы с MinIO
]
...
# Используем S3 для статических файлов и медиа
